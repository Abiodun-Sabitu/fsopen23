...
const Button = ({ handleClick, btnName }) => {
  //console.log(handleClick, btnName);
...
const App = () => {
  ...
  const randomAnecdotes = [Math.floor(Math.random() * totalAnecdotes)];
  ...
  return (
    <>
      ...
      <Button handleClick={voteForAnecdote} btnName="vote" />
      <Button
        handleClick={() => setSelected(randomAnecdotes)}
